...
- docs: close the slice-4 shell/contracts epic and advance the slice-4 board MVP epic as the current task
...
- test: pin renderer-frame focus-target priority over competing non-selected positioned cars
